...
- **auto_ban 策略优化**: 免费源（ch35 cline-free、ch43 atomcode、ch44 codebuddy、ch45 agentrouter）关 `auto_ban`，避免间歇性 429/503/403 导致永久 ban。付费源（ch14/15/37/38/42）保持 auto_ban=1。
