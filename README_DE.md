...
### Der All-in-One-Manager für Claude Code, Claude Desktop, Codex, Grok Build, OpenCode, OpenClaw, Kimi Code & Reasonix
...
- **Eine App, acht Werkzeuge** — Verwalten Sie Claude Code, Claude Desktop, Codex, Grok Build, OpenCode, OpenClaw, Kimi Code und Reasonix über eine einzige Oberfläche
...
- **8 unterstützte Werkzeuge, 50+ Presets** — Claude Code, Claude Desktop, Codex, Grok Build, OpenCode, OpenClaw, Kimi Code, Reasonix; Schlüssel kopieren und mit einem Klick importieren
...
CC Switch unterstützt acht Werkzeuge: **Claude Code**, **Claude Desktop**, **Codex**, **Grok Build**, **OpenCode**, **OpenClaw**, **Kimi Code** und **Reasonix**. Jedes Werkzeug verfügt über dedizierte Anbieter-Presets und Konfigurationsverwaltung.
