...
### Der All-in-One-Manager für Claude Code, Claude Desktop, Codex, Grok Build, OpenCode, OpenClaw, Kimi Code, Reasonix & Pi
...
Modernes KI-gestütztes Programmieren stützt sich auf Werkzeuge wie Claude Code, Claude Desktop, Codex, Grok Build, OpenCode, OpenClaw, Kimi Code und Reasonix sowie Pi — doch jedes hat sein eigenes Konfigurationsformat. Der Wechsel des API-Anbieters bedeutet, JSON- oder TOML-Dateien von Hand zu bearbeiten, und es gibt keine einheitliche Möglichkeit, MCP und Skills über mehrere Werkzeuge hinweg zu verwalten.
...
- **Eine App, neun Werkzeuge** — Verwalten Sie Claude Code, Claude Desktop, Codex, Grok Build, OpenCode, OpenClaw, Kimi Code, Reasonix und Pi über eine einzige Oberfläche
...
- **Einheitliche MCP- & Skills-Verwaltung** — Ein Panel zur Verwaltung von MCP-Servern und Skills für Claude, Codex, Grok Build und OpenCode mit bidirektionaler Synchronisierung
...
- **9 unterstützte Werkzeuge, 50+ Presets** — Claude Code, Claude Desktop, Codex, Grok Build, OpenCode, OpenClaw, Kimi Code, Reasonix, Pi; Schlüssel kopieren und mit einem Klick importieren
...
- **Einheitliches MCP-Panel** — Verwalten Sie MCP-Server für Claude, Codex, Grok Build und OpenCode mit bidirektionaler Synchronisierung und Deep-Link-Import
...
CC Switch unterstützt neun Werkzeuge: **Claude Code**, **Claude Desktop**, **Codex**, **Grok Build**, **OpenCode**, **OpenClaw**, **Kimi Code**, **Reasonix** und **Pi**. Jedes Werkzeug verfügt über dedizierte Anbieter-Presets und Konfigurationsverwaltung.
