...
### Der All-in-One-Manager für Claude Code, Claude Desktop, Codex, Grok Build, OpenCode, OpenClaw & Kimi Code
...
- **Eine App, sieben Werkzeuge** — Verwalten Sie Claude Code, Claude Desktop, Codex, Grok Build, OpenCode, OpenClaw und Kimi Code über eine einzige Oberfläche
...
- **7 unterstützte Werkzeuge, 50+ Presets** — Claude Code, Claude Desktop, Codex, Grok Build, OpenCode, OpenClaw, Kimi Code; Schlüssel kopieren und mit einem Klick importieren
...
CC Switch unterstützt sieben Werkzeuge: **Claude Code**, **Claude Desktop**, **Codex**, **Grok Build**, **OpenCode**, **OpenClaw** und **Kimi Code**. Jedes Werkzeug verfügt über dedizierte Anbieter-Presets und Konfigurationsverwaltung.
