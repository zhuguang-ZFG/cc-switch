...
### Claude Code、Claude Desktop、Codex、Grok Build、OpenCode、OpenClaw 和 Kimi Code 的全方位管理工具
...
现代 AI 编程依赖于 Claude Code、Claude Desktop、Codex、Grok Build、OpenCode、OpenClaw 和 Kimi Code 等工具——但每个工具都有自己的配置格式。切换 API 供应商意味着手动编辑 JSON 或 TOML 文件，而在多个工具之间缺乏一个统一管理 MCP、Skills 的方式。
...
- **一个应用，七个工具** — 在单一界面中管理 Claude Code、Claude Desktop、Codex、Grok Build、OpenCode、OpenClaw 和 Kimi Code
...
- **7 个支持工具，50+ 预设** — Claude Code、Claude Desktop、Codex、Grok Build、OpenCode、OpenClaw、Kimi Code；复制 key 即可一键导入
...
CC Switch 支持七个工具：**Claude Code**、**Claude Desktop**、**Codex**、**Grok Build**、**OpenCode**、**OpenClaw** 和 **Kimi Code**。每个工具都有专属的供应商预设和配置管理。
