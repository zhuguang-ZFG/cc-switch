...
### The All-in-One Manager for Claude Code, Claude Desktop, Codex, Grok Build, OpenCode, OpenClaw & Kimi Code
...
- **One App, Seven Tools** — Manage Claude Code, Claude Desktop, Codex, Grok Build, OpenCode, OpenClaw, and Kimi Code from a single interface
...
- **7 supported tools, 50+ presets** — Claude Code, Claude Desktop, Codex, Grok Build, OpenCode, OpenClaw, Kimi Code; copy your key and import with one click
...
CC Switch supports seven tools: **Claude Code**, **Claude Desktop**, **Codex**, **Grok Build**, **OpenCode**, **OpenClaw**, and **Kimi Code**. Each tool has dedicated provider presets and configuration management.
