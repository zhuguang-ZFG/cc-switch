...
- jianzhile sol 第五梯队渠道脚本：`scripts/ops/add_jianzhile_gpt56sol_channel.py`（ch91，双 key 轮询，priority 10 垫底；2026-08-13 曾因上游确定性 403 拒入、2026-08-17 新 key 探针 200 复入，同日第二 key 到位转 multi_to_single——fork 的 `status_list:null`/`mode:""` 坑重现，DB BLOB 修复生效，runbook 见 `docs/ops/jianzhile-gpt56sol-channel-2026-08-17.md`）
