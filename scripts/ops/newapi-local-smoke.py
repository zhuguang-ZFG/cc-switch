...
KNOWN_BROKEN_CHANNELS: set[int] = {2, 18, 57, 62, 63, 64, 65, 70, 71, 73, 74}  # 18: linxi opus5-backup 测试超时；57: gorouter 余额不足；70/71: 上游真死（2026-08-08 实测），与 Guardian 排除集一致；73/74: relay 渠道上游 405 禁用中
