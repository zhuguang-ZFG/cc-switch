...
- **App-specific Provider**: Only for the currently selected app (Claude Code / Claude Desktop / Codex / Grok Build / OpenCode / OpenClaw / Kimi Code / Reasonix)
...
This feature is available in model-aware provider forms for **Claude Code / Claude Desktop / Codex / Grok Build / OpenCode / OpenClaw / Kimi Code / Reasonix**, and works for providers that support the `/v1/models` endpoint. Codex OAuth providers fetch live model lists from the ChatGPT Codex backend on demand.
