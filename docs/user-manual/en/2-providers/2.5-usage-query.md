...
| ------------------------------ | -------------------------------------------------------------------------- | -------------------- |
| **Auto Query**                 | Claude / Codex / Kimi Code official subscriptions, GitHub Copilot, Codex OAuth reverse proxy | No (enabled by default) |
...
| ---------------- | ----------------------------------------------------- | ----------------------------------------- |
| Official subscriptions | Claude / Codex / Kimi Code official login      | Official subscription quota               |
...
**Check**:
1. Confirm the provider is an official subscription type — Claude / Codex / Kimi Code official login, GitHub Copilot, or Codex OAuth reverse proxy
