...
CC Switch is a cross-platform desktop application designed for developers who use AI tools. It helps you centrally manage configurations for **Claude Code**, **Claude Desktop**, **Codex**, **Grok Build**, **OpenCode**, **OpenClaw**, **Kimi Code**, **Reasonix**, and **Pi**.
...
- **Scattered configurations**: Claude Code, Claude Desktop, Codex, Grok Build, OpenCode, OpenClaw, Kimi Code, Reasonix, and Pi each have independent configuration files in different formats
...
| **Grok Build** | xAI's Grok-powered AI coding tool |
| **OpenCode** | Open-source AI coding terminal tool |
| **OpenClaw** | Open-source AI assistant (multi-provider gateway) |
| **Kimi Code** | Moonshot AI's Kimi coding CLI (providers, MCP, Skills, and Sessions) |
| **Reasonix** | Reasonix AI coding CLI (providers, MCP plugins, Skills, and Sessions) |
| **Pi** | Pi coding agent (`~/.pi/agent`: providers, Skills, Prompts, and Sessions; no MCP) |
