...
| 4 | App Switcher | Switch between Claude / Claude Desktop / Codex / Grok Build / OpenCode / OpenClaw / Kimi Code / Reasonix |
...
|--------|----------|------------|
| Skills | Skill extension management | Claude / Codex / Grok Build / OpenCode / Kimi Code / Reasonix |
| Prompts | System prompt management | Claude / Codex / Grok Build / OpenCode / OpenClaw / Kimi Code / Reasonix |
...
> **Note**: Each tray submenu title shows the current provider name (e.g., "Claude · PackyCode"). Apps with no configured providers show a disabled "(no providers)" entry. The tray currently focuses on Claude / Codex / Grok Build, the apps that support proxy routing and usage summaries; main-window app visibility is still controlled by the App Visibility setting.
