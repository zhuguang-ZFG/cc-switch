...
| 4 | App Switcher | Switch between Claude / Claude Desktop / Codex / Grok Build / OpenCode / OpenClaw / Kimi Code / Reasonix / Pi |
...
- **Kimi Code** - Manage Kimi Code configuration
- **Reasonix** - Manage Reasonix configuration
- **Pi** - Manage Pi agent configuration
...
|--------|----------|------------|
| Skills | Skill extension management | Claude / Codex / Grok Build / OpenCode / Kimi Code / Reasonix / Pi |
| Prompts | System prompt management | Claude / Codex / Grok Build / OpenCode / OpenClaw / Kimi Code / Reasonix / Pi |
| MCP | MCP server management | Claude / Codex / Grok Build / OpenCode / Kimi Code / Reasonix |
...
| App Submenus | Collapsible submenus grouped by app (e.g., "Claude · PackyCode"), with current provider and cached usage summaries when available |
...
> **Note**: Each tray submenu title shows the current provider name (e.g., "Claude · PackyCode"). Apps with no configured providers show a disabled "(no providers)" entry. The tray currently focuses on Claude / Codex / Grok Build / Kimi Code / Reasonix / Pi, the apps that support proxy routing and usage summaries; main-window app visibility is still controlled by the App Visibility setting.
