...
Configurable apps: Claude, Claude Desktop, Codex, Grok Build, OpenCode, OpenClaw, Kimi Code, Reasonix.
...
Click the "Copy" button to copy to clipboard. For Grok Build, Kimi Code, and Reasonix, use the install/update buttons in the About tab, which run the correct command for each tool automatically.
