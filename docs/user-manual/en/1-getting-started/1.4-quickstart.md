...
| Kimi Code | Instant effect (saves take effect immediately) |
...
# Grok Build - enter a test question after launching
grok
> Hello, please briefly introduce yourself
...
Select the "Official Login" preset (Claude/Codex), restart the client, and follow the login flow.
