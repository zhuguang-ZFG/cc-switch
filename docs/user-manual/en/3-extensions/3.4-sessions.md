...
> **Note**: The Session Manager covers the seven session sources listed above — every supported app except Claude Desktop.
...
> **Note**: Codex / Grok Build / OpenCode / OpenClaw / Kimi Code / Reasonix session resume flows do not yet include the directory picker and still use the session's original project directory.
