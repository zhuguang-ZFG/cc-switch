...
Skills are supported across seven applications:
...
> **Note**: The Skills panel does not cover Claude Desktop or OpenClaw.
...
- Removes the skill from all app directories (Claude, Codex, Grok Build, OpenCode, Kimi Code, Reasonix, Pi)
