...
Kimi Code and Reasonix provider entries are pointed at `http://127.0.0.1:15721/kimicode/v1` and `http://127.0.0.1:15721/reasonix/v1` respectively; the Pi provider entry in `~/.pi/agent/models.json` is pointed at `http://127.0.0.1:15721/pi/v1`.

> App takeover supports six apps: Claude, Codex, Grok Build, Kimi Code, Reasonix, and Pi. OpenCode and OpenClaw do not support the proxy feature.
...
|-------|-------------|
| Time | Request time |
| App | Claude / Codex / Grok Build / Kimi Code / Reasonix / Pi |
