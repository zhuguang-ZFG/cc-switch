...
Kimi Code and Reasonix provider entries are pointed at `http://127.0.0.1:15721/kimicode/v1` and `http://127.0.0.1:15721/reasonix/v1` respectively.

> App takeover supports five apps: Claude, Codex, Grok Build, Kimi Code, and Reasonix. OpenCode and OpenClaw do not support the proxy feature.
...
|-------|-------------|
| Time | Request time |
| App | Claude / Codex / Grok Build / Kimi Code / Reasonix |
