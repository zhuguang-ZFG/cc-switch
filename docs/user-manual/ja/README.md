...
> Claude Code / Claude Desktop / Codex / Gemini CLI / OpenCode / OpenClaw / Kimi Code / Reasonix オールインワンアシスタント
...
- **管理対象 CLI ツールのライフサイクル**：設定 / About で Claude / Codex / Gemini / OpenCode / OpenClaw / Kimi Code / Reasonix のインストール、更新、一括更新、診断に対応 — 詳細は [1.5 個人設定](./1-getting-started/1.5-settings.md)
...
- **OpenCode / OpenClaw / Kimi Code / Reasonix ストリームチェック対応**：Stream Check は Claude / Codex / Gemini / OpenCode / OpenClaw / Kimi Code / Reasonix をカバー — 詳細は [4.5 モデルテスト](./4-proxy/4.5-model-test.md)
