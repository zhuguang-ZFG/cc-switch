...
> Claude Code / Claude Desktop / Codex / Grok Build / OpenCode / OpenClaw / Kimi Code / Reasonix 全方位辅助工具
...
- **托管 CLI 工具生命周期**：在设置 / 关于页安装、升级、全部升级并诊断 Claude / Codex / Grok Build / OpenCode / OpenClaw / Kimi Code / Reasonix — 详见 [1.5 个性化配置](./1-getting-started/1.5-settings.md)
...
- **配额与余额展示**：官方订阅类（Claude/Codex/Gemini/Kimi Code/Copilot/Codex OAuth）自动展示剩余额度；Token Plan 和第三方余额通过内置模板一键启用 — 详见 [2.5 用量查询](./2-providers/2.5-usage-query.md)
- **Codex OAuth 反向代理**：用 ChatGPT 账号在 Claude Code 中复用 Codex 服务 — 详见 [2.1 添加供应商](./2-providers/2.1-add.md)
- **托盘按应用分级菜单**：Claude / Codex / Grok Build / Kimi Code / Reasonix 独立子菜单，标题展示当前供应商与可用用量摘要 — 详见 [2.2 切换供应商](./2-providers/2.2-switch.md)
...
- **OpenCode / OpenClaw / Kimi Code / Reasonix 流式检测覆盖**：Stream Check 面板覆盖 Claude / Claude Desktop / Codex / Grok Build / OpenCode / OpenClaw / Kimi Code / Reasonix 全部 8 个应用 — 详见 [4.5 模型检查](./4-proxy/4.5-model-test.md)
