...
CC Switch 是一款跨平台桌面应用，专为使用 AI 工具的开发者设计。它帮助你统一管理 **Claude Code**、**Claude Desktop**、**Codex**、**Grok Build**、**OpenCode**、**OpenClaw**、**Kimi Code**、**Reasonix** 和 **Pi** 等受管应用的配置。
...
- **配置分散难管理**：Claude Code、Claude Desktop、Codex、Grok Build、OpenCode、OpenClaw、Kimi Code、Reasonix、Pi 各有独立的配置文件，格式不同
...
| **Grok Build** | xAI 的 AI 命令行编程工具 |
| **OpenCode** | 开源 AI 编程终端工具 |
| **OpenClaw** | 开源 AI 助手（多供应商网关） |
| **Kimi Code** | Moonshot AI 的命令行编程工具，支持供应商、MCP、Skills 与会话管理 |
| **Reasonix** | Reasonix Agent，支持供应商、MCP、Skills 与会话管理 |
| **Pi** | Pi 编程 Agent（`~/.pi/agent`），支持供应商、Skills、Prompts 与会话管理（不支持 MCP） |
